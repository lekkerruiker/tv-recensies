...
def get_ai_sorted_list(articles):
    ...
    try:
        ...
        # Reconstruct de lijst in de nieuwe volgorde
        return [articles[i] for i in ids if i < len(articles)]
    except Exception as e:
        print(f"AI Sortering mislukt, we gebruiken de standaard volgorde: {e}")
        return articles

def run_scraper():
    all_found = []
    seen_links = set()
    # Brede verzameling van alles wat met media te maken heeft
    keywords = ['tv', 'televisie', 'omroep', 'npo', 'rtl', 'sbs', 'recensie', 'kijkt', 'zap', 'lips', 'fortuin', 'nijkamp', 'talkshow', 'serie', 'mafs']
        ...
        try:
            ...
            for item in items:
                ...
                if t_match and l_match:
                    ...
                    # Ruim filter: link of titel moet een keyword bevatten
    ...
    # Laat de AI de volgorde bepalen
    ...
    for i, art in enumerate(sorted_articles, 1):
        ...
        # Visuele indicator voor de top-items
